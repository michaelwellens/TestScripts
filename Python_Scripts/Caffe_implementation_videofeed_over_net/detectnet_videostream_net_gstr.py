...
if __name__ == '__main__':
    ...
    while True:
        ...
        video = cv2.VideoWriter('appsrc ! videoconvert ! videoscale ! video/x-raw,width=320,height=240 ! theoreanc ! oggmux ! tcpserversink host="127.0.0.1" port="5001"',0,25.0,(320,240))
        video.write(frame)
